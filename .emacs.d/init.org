...
This configuration is heavily inspired by the *Emacs From Scratch* series by the Youtube channel SystemCrafters.
...
;    (setq org-log-into-drawer t)
    ...
    (setq org-agenda-files
          '("~/Desktop/schedule/tasks.org"
            "~/Desktop/schedule/habits.org"
            "~/Desktop/schedule/birthdays.org"))
...
;    :mode "\\.hs\\'"
;    :hook (haskell-indentation-mode haskell-interactive-mode))
...
[[https://github.com/gregsexton/ob-ipython][ob-ipython]] is similar to ein.
...
Useful utility to surround text with any kind of characters, i.e. ', ", [], even html tags or whatever you want. It is based on surround.vim. See [[https://github.com/emacs-evil/evil-surround][evil-surround]] for documentation.
