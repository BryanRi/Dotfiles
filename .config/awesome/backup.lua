...
-- Custom functions
-- lock screen app
lock_screen = function () awful.util.spawn("slock") end
-- Battery widget
...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Creat a systray widget

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, fg = "white" })
...
globalkeys = gears.table.join(
	...
	awful.key({}, "XF86AudioRaiseVolume", function () 
		awful.util.spawn("amixer -D pulse sset Master 9%+", false) end),
	...
	awful.key({ modkey			}, "b",	function () awful.util.spawn(browser)		end,
			  {description = "launch " .. browser .. " browser", group = "applications"}),
...
if autorun then
   for app = 1, #autorunApps do
       awful.spawn.with_shell(autorunApps[app]) --use awful.util.spawn("program") for gui apps
   end
end
