...
myXmobarrc = "~/.xmonad/xmobar-low-contrast-rc"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask .|. controlMask .|. shiftMask, xK_p),
     spawn myScreenshot)
{- easynote with arch volume commands
  -- Mute volume.
  , ((0, xF86XK_AudioMute),
  ...
  , ((0, xF86XK_AudioRaiseVolume),
     spawn "amixer -q set Master 5%+")
-}
-- xps with arch volume commands
  -- Mute volume.
  , ((0, xF86XK_AudioMute),
     spawn "amixer sset Speaker toggle")

  -- Decrease volume.
  , ((0, xF86XK_AudioLowerVolume),
     spawn "amixer sset 'PGA3.1 3 Master' 5%-")
...
myXmobarPP = def
    { ppSep             = magenta " | "
    , ppWsSep           = " "
    , ppTitle           = orange . shorten 50
    , ppTitleSanitize   = xmobarStrip
    , ppLayout          = white
    , ppCurrent         = orange . wrap "[" "]"
    , ppHidden          = white
